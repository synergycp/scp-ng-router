...
!function(){"use strict";angular.module("scp.router",["ui.router","oc.lazyLoad","ct.ui.router.extras","scp.core.auth","scp.router.lazyload","scp.router.url"])}(),function(){"use strict";angular.module("scp.router.lazyload",[])}(),function(){"use strict";angular.module("scp.router.url",[])}(),function(){"use strict";function n(n,t,r,e,u,a){function o(n,t,r,e){function u(){return a.map(arguments,a.ary(t.addPart,1)),console.log("loading ",arguments),r.refresh()}function o(t){return n.trustAsResourceUrl(t)}function s(){function n(n){return l.loadLang(u.getLangName(n))}function t(){return e.all("pkg").all(u.name)}function r(n){return o(u.asset(n))}var u=c.apply(null,arguments);return u.trustedAsset=r,u.api=t,u.loadLang=n,u}var l=a.clone(g);return l.trusted=o,l.package=s,l.export=i,l.loadLang=u,l}function i(n){return new s(n)}function s(n){function t(n){return u=r(n),e}function r(n){return u+"/"+n}var e=this,u="vendor/"+n;e.root=t,e.path=r}function c(n){return new d(n)}function l(n){return"app/"+n}function f(t){return n.urlTransformers.map(function(n){t=n(t)}),t}function p(n){return f("vendor/scp-angle/dist/"+n)}function d(n){function o(t,e){function u(){var n=a.map(arguments);return n[0]=s(n[0]),e.apply(e,n)}r.map("pkg."+n+"."+t,u)}function i(n,t){function r(){var n=a.map(arguments);return n[0]=s(n[0]),t.apply(t,n)}return e.map(h+n,r),v}function s(n){function t(){var t=a.map(arguments);return t[0]=v.baseState+"."+t[0],n.href.apply(n,t)}var r=a.clone(n);return r.href=t,r}function c(n){return"lang:"+l(n)}function l(t){return"pkg:"+n+":"+t}function f(t){u.state(v.baseState,a.defaults({},t||{},{url:"/"+n,abstract:!0,template:g.dummyTemplate}))}function p(n,t){return n?(u.state(v.baseState+"."+n,t),v):(f(t),v)}function d(n){return t.baseUrl()+"/static/"+h+n}function m(n){return"raw:"+d(n)}var v=this,h="pkg/"+n+"/";v.baseState="app.pkg."+n,v.name=n,v.asset=d,v.lang=c,v.state=p,v.raw=m,v.url=i,v.sso=o,v.getLangName=l}function m(){function t(t,e,u,o){function i(n){var r=t.when(n);return"function"==typeof n?r.then(n):p=r.then(s.bind(null,n,p)).catch(function(t){console.error("Error loading: ",n,t)})}function s(n,t){function r(){return s(p,a)}var a,i=n.split(":"),f=i.shift(),p=i.join(":");switch(f){case"lang":return l(p),console.log(p),o.loadLang(p);case"inject":return e.get(p)();case"raw":return l(p),u.load(p);case"after":return a=t.then(r)}var d=c(n);return d?(l(d),u.load(d)):$.error("Route resolve: Bad resource name ["+n+"]")}function c(t){if(n.modules)for(var r in n.modules)if(n.modules[r].name&&n.modules[r].name===t)return n.modules[r];return n.scripts&&n.scripts[t]}function l(n){var t=null;if(a.isObject(n)&&a.isArray(n.files))t=n.files;else{if(!a.isArray(n))return n;t=n}return t.map(function(n,r){t[r]=f(t[r])}),n}var p;return t.all(a.map(r,i))}t.$inject=["$q","$injector","$ocLazyLoad","RouteHelpers"];var r=arguments;return{deps:t}}o.$inject=["$sce","$translateModuleLoader","$translate","Api"];var g={sso:r,url:e,state:u.state,basepath:l,themepath:p,resolveFor:m,dummyTemplate:'<ui-view ng-class="app.viewAnimation" />',package:c,$get:o};return g}n.$inject=["APP_REQUIRES","ApiProvider","SsoUrlProvider","UrlProvider","$stateProvider","_"],angular.module("scp.router").provider("RouteHelpers",n)}(),function(){"use strict";function n(n){n.hashPrefix("")}n.$inject=["$locationProvider"],angular.module("scp.router").config(n)}(),function(){"use strict";function n(n,t){n.config({debug:!1,events:!0,modules:t.modules})}n.$inject=["$ocLazyLoadProvider","APP_REQUIRES"],angular.module("scp.router.lazyload").config(n)}(),function(){"use strict";angular.module("scp.router.lazyload").constant("APP_REQUIRES",{scripts:{},modules:[],urlTransformers:[]})}(),function(){"use strict";function n(){function n(){return o}function e(n){o=n}function u(n,r){return new t(n,r,s,i)}function a(n,t){i.push(new r(n,t))}u.$inject=["_","$state"];var o,i=[],s={$get:u,map:a,getBaseState:n,setBaseState:e};return s}function t(n,t,r,e){function u(t){function r(n,r){return n||a(r,t)}return n.reduce(e,r,null)||l(t)}function a(n,r){var e=n.result(r,t);if(e)return o()+e}function o(){return f=f||i()}function i(){var n=t.href(s()).split("?")[0];return"#"===n&&(n+="/"),n}function s(){return r.getBaseState()||c()}function c(){throw new Error("No base state set in UrlProvider.")}function l(n){console.warn("URL does not match any known URLs: "+n)}var f,p=this;p.get=u,p.map=r.map}function r(n,t){function r(n,r){var a=n.match(u);if(a){a.shift(),a.unshift(r);var o=t.apply(e,a);return o&&"#"===o.charAt(0)&&(o=o.substring(1)),o}}var e=this,u=new RegExp(n);e.result=r}t.$inject=["_","$state","UrlProvider","mappings"],angular.module("scp.router.url").provider("Url",n)}();