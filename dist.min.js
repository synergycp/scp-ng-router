...
!function(){"use strict";angular.module("scp.router",["ui.router","oc.lazyLoad","ct.ui.router.extras","scp.router.lazyload","scp.router.url"])}(),function(){"use strict";angular.module("scp.router.lazyload",[])}(),function(){"use strict";angular.module("scp.router.url",[])}(),function(){"use strict";function t(t,r,n,e,u,a){function o(t,r,n,e){function u(){return a.map(arguments,a.ary(r.addPart,1)),n.refresh()}function o(r){return t.trustAsResourceUrl(r)}function s(){function t(){return e.all("pkg").all(n.name)}function r(t){return o(n.asset(t))}var n=c.apply(null,arguments);return n.trustedAsset=r,n.api=t,n}var l=a.clone(m);return l.trusted=o,l.package=s,l.export=i,l.loadLang=u,l}function i(t){return new s(t)}function s(t){function r(t){return u=n(t),e}function n(t){return u+"/"+t}var e=this,u="vendor/"+t;e.root=r,e.path=n}function c(t){return new p(t)}function l(t){return"app/"+t}function f(t){return"vendor/scp-angle/dist/"+t}function p(t){function o(r,e){function u(){var t=a.map(arguments);return t[0]=s(t[0]),e.apply(e,t)}n.map("pkg."+t+"."+r,u)}function i(t,r){function n(){var t=a.map(arguments);return t[0]=s(t[0]),r.apply(r,t)}return e.map(g+t,n),v}function s(t){function r(){var r=a.map(arguments);return r[0]=v.baseState+"."+r[0],t.href.apply(t,r)}var n=a.clone(t);return n.href=r,n}function c(r){return"lang:pkg:"+t+":"+r}function l(r){u.state(v.baseState,a.defaults({},r||{},{url:"/"+t,abstract:!0,template:m.dummyTemplate}))}function f(t,r){return t?(u.state(v.baseState+"."+t,r),v):(l(r),v)}function p(t){return r.baseUrl()+g+t}function d(t){return"raw:"+p(t)}var v=this,g="pkg/"+t+"/";v.baseState="app.pkg."+t,v.name=t,v.asset=p,v.lang=c,v.state=f,v.raw=d,v.url=i,v.sso=o}function d(){function r(r,e,u,o,i){function s(t){var n=r.when(t);return"function"==typeof t?n.then(t):f=n.then(c.bind(null,t,f)).catch(function(r){console.error("Error loading: ",t,r)})}function c(t,r){function n(){return c(s,f)}var e=t.split(":"),a=e.shift(),s=e.join(":");switch(a){case"lang":return i.loadLang(s);case"inject":return u.get(s)();case"raw":return o.load(s);case"after":var f=r.then(n);return f}var p=l(t);return p?o.load(p):$.error("Route resolve: Bad resource name ["+t+"]")}function l(r){if(t.modules)for(var n in t.modules)if(t.modules[n].name&&t.modules[n].name===r)return t.modules[n];return t.scripts&&t.scripts[r]}var f;return r.all(a.map(n,s))}r.$inject=["$q","$timeout","$injector","$ocLazyLoad","RouteHelpers"];var n=arguments;return{deps:r}}o.$inject=["$sce","$translateModuleLoader","$translate","Api"];var m={sso:n,url:e,state:u.state,basepath:l,themepath:f,resolveFor:d,dummyTemplate:"<ui-view />",package:c,$get:o};return m}t.$inject=["APP_REQUIRES","ApiProvider","SsoUrlProvider","UrlProvider","$stateProvider","_"],angular.module("scp.router").provider("RouteHelpers",t)}(),function(){"use strict";function t(t,r){t.config({debug:!1,events:!0,modules:r.modules})}t.$inject=["$ocLazyLoadProvider","APP_REQUIRES"],angular.module("scp.router.lazyload").config(t)}(),function(){"use strict";angular.module("scp.router.lazyload").constant("APP_REQUIRES",{scripts:{},modules:[]})}(),function(){"use strict";function t(){function t(){return o}function e(t){o=t}function u(t,n){return new r(t,n,s,i)}function a(t,r){i.push(new n(t,r))}u.$inject=["_","$state"];var o,i=[],s={$get:u,map:a,getBaseState:t,setBaseState:e};return s}function r(t,r,n,e){function u(r){function n(t,n){return t||a(n,r)}return t.reduce(e,n,null)||c(r)}function a(t,n){var e=t.result(n,r);if(e)return o()+e}function o(){return l=l||r.href(i())}function i(){return n.getBaseState()||s()}function s(){throw new Error("No base state set in UrlProvider.")}function c(t){throw new Error("URL does not match any known URLs: "+t)}var l,f=this;f.get=u,f.map=n.map}function n(t,r){function n(t,n){var a=t.match(u);if(a){a.shift(),a.unshift(n);var o=r.apply(e,a);return o&&"#"===o.charAt(0)&&(o=o.substring(1)),o}}var e=this,u=new RegExp(t);e.result=n}r.$inject=["_","$state","UrlProvider","mappings"],angular.module("scp.router.url").provider("Url",t)}();