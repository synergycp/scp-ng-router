...
!function(){"use strict";angular.module("scp.router",["ui.router","oc.lazyLoad","ct.ui.router.extras","scp.router.lazyload"])}(),function(){"use strict";angular.module("scp.router.lazyload",[])}(),function(){"use strict";function r(r,e,t){function n(r){return new o(r)}function u(r){return"app/"+r}function o(r){function n(e){return"lang:pkg:"+r+":"+e}function u(r,e){return t.state(r,e),s}function o(r){return e.baseUrl()+c+r}function a(r){return"raw:"+o(r)}var s=this,c="pkg/"+r+"/";s.asset=o,s.lang=n,s.state=u,s.raw=a}function a(){function e(e,n,u,o,a,s){function c(r){var t=e.when(r);return"function"==typeof r?t.then(r):d=t.then(i.bind(null,r,d))}function i(r,e){var t=r.split(":"),n=t.shift(),c=t.join(":");switch(n){case"lang":return s.addPart(c),o.refresh();case"inject":return u.get(c)();case"raw":return a.load(c);case"after":return e.then(function(){return i(c)})}var d=l(r);return d?a.load(d):$.error("Route resolve: Bad resource name ["+r+"]")}function l(e){if(r.modules)for(var t in r.modules)if(r.modules[t].name&&r.modules[t].name===e)return r.modules[t];return r.scripts&&r.scripts[e]}var d;return e.all(_.map(t,c))}e.$inject=["$q","$timeout","$injector","$translate","$ocLazyLoad","$translateModuleLoader"];var t=arguments;return{deps:e}}var s={basepath:u,resolveFor:a,dummyTemplate:"<ui-view />",package:n};return s.$get=function(r){function e(e){return r.trustAsResourceUrl(e)}function t(){function r(r){return e(t.asset(r))}var t=n.apply(null,arguments);return t.trustedAsset=r,t}var u=_.clone(s);return u.trusted=e,u.package=t,u},s.$get.$inject=["$sce"],s}r.$inject=["APP_REQUIRES","ApiProvider","$stateProvider"],angular.module("scp.router").provider("RouteHelpers",r)}(),function(){"use strict";function r(r,e){r.config({debug:!1,events:!0,modules:e.modules})}r.$inject=["$ocLazyLoadProvider","APP_REQUIRES"],angular.module("scp.router.lazyload").config(r)}(),function(){"use strict";angular.module("scp.router.lazyload").constant("APP_REQUIRES",{scripts:{},modules:[]})}();