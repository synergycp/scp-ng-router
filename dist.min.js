...
!function(){"use strict";angular.module("scp.router",["ui.router","oc.lazyLoad","ct.ui.router.extras","scp.router.lazyload"])}(),function(){"use strict";angular.module("scp.router.lazyload",[])}(),function(){"use strict";function e(e,r,t){function n(e){return new a(e)}function u(e){return"app/"+e}function o(e){return"vendor/node_modules/scp-angle/dist/"+e}function a(e){function n(r){return"lang:pkg:"+e+":"+r}function u(e,r){return t.state(e,r),s}function o(e){return r.baseUrl()+c+e}function a(e){return"raw:"+o(e)}var s=this,c="pkg/"+e+"/";s.asset=o,s.lang=n,s.state=u,s.raw=a}function s(){function r(r,n,u,o,a,s){function c(e){var t=r.when(e);return"function"==typeof e?t.then(e):d=t.then(i.bind(null,e,d))}function i(e,r){var t=e.split(":"),n=t.shift(),c=t.join(":");switch(n){case"lang":return s.addPart(c),o.refresh();case"inject":return u.get(c)();case"raw":return a.load(c);case"after":return r.then(function(){return i(c)})}var d=l(e);return d?a.load(d):$.error("Route resolve: Bad resource name ["+e+"]")}function l(r){if(e.modules)for(var t in e.modules)if(e.modules[t].name&&e.modules[t].name===r)return e.modules[t];return e.scripts&&e.scripts[r]}var d;return r.all(_.map(t,c))}r.$inject=["$q","$timeout","$injector","$translate","$ocLazyLoad","$translateModuleLoader"];var t=arguments;return{deps:r}}var c={basepath:u,themepath:o,resolveFor:s,dummyTemplate:"<ui-view />",package:n};return c.$get=function(e){function r(r){return e.trustAsResourceUrl(r)}function t(){function e(e){return r(t.asset(e))}var t=n.apply(null,arguments);return t.trustedAsset=e,t}var u=_.clone(c);return u.trusted=r,u.package=t,u},c.$get.$inject=["$sce"],c}e.$inject=["APP_REQUIRES","ApiProvider","$stateProvider"],angular.module("scp.router").provider("RouteHelpers",e)}(),function(){"use strict";function e(e,r){e.config({debug:!1,events:!0,modules:r.modules})}e.$inject=["$ocLazyLoadProvider","APP_REQUIRES"],angular.module("scp.router.lazyload").config(e)}(),function(){"use strict";angular.module("scp.router.lazyload").constant("APP_REQUIRES",{scripts:{},modules:[]})}();