...
!function(){"use strict";angular.module("scp.router",["ui.router","oc.lazyLoad","ct.ui.router.extras","scp.router.lazyload","scp.router.url"])}(),function(){"use strict";angular.module("scp.router.lazyload",[])}(),function(){"use strict";angular.module("scp.router.url",[])}(),function(){"use strict";function r(r,t,n,e,u){function o(r,t,n){function e(){return u.map(arguments,u.ary(t.addPart,1)),n.refresh()}function o(t){return r.trustAsResourceUrl(t)}function i(){function r(r){return o(t.asset(r))}var t=c.apply(null,arguments);return t.trustedAsset=r,t}var s=u.clone(p);return s.trusted=o,s.package=i,s.export=a,s.loadLang=e,s}function a(r){return new i(r)}function i(r){function t(r){return u=n(r),e}function n(r){return u+"/"+r}var e=this,u="vendor/"+r;e.root=t,e.path=n}function c(r){return new f(r)}function s(r){return"app/"+r}function l(r){return"vendor/scp-angle/dist/"+r}function f(r){function n(t){return"lang:pkg:"+r+":"+t}function u(r,t){return e.state(r,t),i}function o(r){return t.baseUrl()+c+r}function a(r){return"raw:"+o(r)}var i=this,c="pkg/"+r+"/";i.asset=o,i.lang=n,i.state=u,i.raw=a}function d(){function t(t,e,o,a,i){function c(r){var n=t.when(r);return"function"==typeof r?n.then(r):f=n.then(s.bind(null,r,f)).catch(function(t){console.error("Error loading: ",r,t)})}function s(r,t){function n(){return s(c,f)}var e=r.split(":"),u=e.shift(),c=e.join(":");switch(u){case"lang":return i.loadLang(c);case"inject":return o.get(c)();case"raw":return a.load(c);case"after":var f=t.then(n);return f}var d=l(r);return d?a.load(d):$.error("Route resolve: Bad resource name ["+r+"]")}function l(t){if(r.modules)for(var n in r.modules)if(r.modules[n].name&&r.modules[n].name===t)return r.modules[n];return r.scripts&&r.scripts[t]}var f;return t.all(u.map(n,c))}t.$inject=["$q","$timeout","$injector","$ocLazyLoad","RouteHelpers"];var n=arguments;return{deps:t}}o.$inject=["$sce","$translateModuleLoader","$translate"];var p={url:n.map,state:e.state,basepath:s,themepath:l,resolveFor:d,dummyTemplate:"<ui-view />",package:c,$get:o};return p}r.$inject=["APP_REQUIRES","ApiProvider","UrlProvider","$stateProvider","_"],angular.module("scp.router").provider("RouteHelpers",r)}(),function(){"use strict";function r(r,t){r.config({debug:!1,events:!0,modules:t.modules})}r.$inject=["$ocLazyLoadProvider","APP_REQUIRES"],angular.module("scp.router.lazyload").config(r)}(),function(){"use strict";angular.module("scp.router.lazyload").constant("APP_REQUIRES",{scripts:{},modules:[]})}(),function(){"use strict";function r(){function r(){return a}function e(r){a=r}function u(r,n){return new t(r,n,c,i)}function o(r,t){i.push(new n(r,t))}u.$inject=["_","$state"];var a,i=[],c={$get:u,map:o,getBaseState:r,setBaseState:e};return c}function t(r,t,n,e){function u(t){function n(r,n){return r||o(n,t)}return r.reduce(e,n,null)||s(t)}function o(r,t){var n=r.result(t);if(n)return a()+n}function a(){return l=l||t.href(i())}function i(){return n.getBaseState()||c()}function c(){throw new Error("No base state set in UrlProvider.")}function s(r){throw new Error("URL does not match any known URLs: "+r)}var l,f=this;f.get=u,f.map=n.map}function n(r,t){function n(r){var n=r.match(u);if(n)return n.shift(),t.apply(e,n)}var e=this,u=new RegExp(r);e.result=n}t.$inject=["_","$state","UrlProvider","mappings"],angular.module("scp.router.url").provider("Url",r)}();