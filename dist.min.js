...
!function(){"use strict";angular.module("scp.router",["ui.router","oc.lazyLoad","ct.ui.router.extras","scp.router.lazyload"])}(),function(){"use strict";angular.module("scp.router.lazyload",[])}(),function(){"use strict";function r(r,e,t,n){function u(r,e,t){function u(){return n.map(arguments,n.ary(e.addPart,1)),t.refresh()}function a(e){return r.trustAsResourceUrl(e)}function c(){function r(r){return a(e.asset(r))}var e=o.apply(null,arguments);return e.trustedAsset=r,e}var s=n.clone(l);return s.trusted=a,s.package=c,s.loadLang=u,s}function o(r){return new s(r)}function a(r){return"app/"+r}function c(r){return"vendor/scp-angle/dist/"+r}function s(r){function n(e){return"lang:pkg:"+r+":"+e}function u(r,e){return t.state(r,e),c}function o(r){return e.baseUrl()+s+r}function a(r){return"raw:"+o(r)}var c=this,s="pkg/"+r+"/";c.asset=o,c.lang=n,c.state=u,c.raw=a}function i(){function e(e,u,o,a,c){function s(r){var t=e.when(r);return"function"==typeof r?t.then(r):d=t.then(i.bind(null,r,d)).catch(function(e){console.error("Error loading: ",r,e)})}function i(r,e){function t(){return i(s,d)}var n=r.split(":"),u=n.shift(),s=n.join(":");switch(u){case"lang":return c.loadLang(s);case"inject":return o.get(s)();case"raw":return a.load(s);case"after":var d=e.then(t);return d}var f=l(r);return f?a.load(f):$.error("Route resolve: Bad resource name ["+r+"]")}function l(e){if(r.modules)for(var t in r.modules)if(r.modules[t].name&&r.modules[t].name===e)return r.modules[t];return r.scripts&&r.scripts[e]}var d;return e.all(n.map(t,s))}e.$inject=["$q","$timeout","$injector","$ocLazyLoad","RouteHelpers"];var t=arguments;return{deps:e}}u.$inject=["$sce","$translateModuleLoader","$translate"];var l={basepath:a,themepath:c,resolveFor:i,dummyTemplate:"<ui-view />",package:o,$get:u};return l}r.$inject=["APP_REQUIRES","ApiProvider","$stateProvider","_"],angular.module("scp.router").provider("RouteHelpers",r)}(),function(){"use strict";function r(r,e){r.config({debug:!1,events:!0,modules:e.modules})}r.$inject=["$ocLazyLoadProvider","APP_REQUIRES"],angular.module("scp.router.lazyload").config(r)}(),function(){"use strict";angular.module("scp.router.lazyload").constant("APP_REQUIRES",{scripts:{},modules:[]})}();