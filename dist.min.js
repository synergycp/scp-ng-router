...
!function(){"use strict";angular.module("scp.router",["ui.router","oc.lazyLoad","ct.ui.router.extras","scp.router.lazyload"])}(),function(){"use strict";angular.module("scp.router.lazyload",[])}(),function(){"use strict";function r(r,e,t,n){function u(r){function e(e){return r.trustAsResourceUrl(e)}function t(){function r(r){return e(t.asset(r))}var t=o.apply(null,arguments);return t.trustedAsset=r,t}var u=n.clone(l);return u.trusted=e,u.package=t,u}function o(r){return new s(r)}function a(r){return"app/"+r}function c(r){return"vendor/scp-angle/dist/"+r}function s(r){function n(e){return"lang:pkg:"+r+":"+e}function u(r,e){return t.state(r,e),c}function o(r){return e.baseUrl()+s+r}function a(r){return"raw:"+o(r)}var c=this,s="pkg/"+r+"/";c.asset=o,c.lang=n,c.state=u,c.raw=a}function i(){function e(e,u,o,a,c,s){function i(r){var t=e.when(r);return"function"==typeof r?t.then(r):f=t.then(l.bind(null,r,f)).catch(function(e){console.error("Error loading: ",r,e)})}function l(r,e){function t(){return l(i,f)}var n=r.split(":"),u=n.shift(),i=n.join(":");switch(u){case"lang":return s.addPart(i),a.refresh();case"inject":return o.get(i)();case"raw":return c.load(i);case"after":var f=e.then(t);return f}var p=d(r);return p?c.load(p):$.error("Route resolve: Bad resource name ["+r+"]")}function d(e){if(r.modules)for(var t in r.modules)if(r.modules[t].name&&r.modules[t].name===e)return r.modules[t];return r.scripts&&r.scripts[e]}var f;return e.all(n.map(t,i))}e.$inject=["$q","$timeout","$injector","$translate","$ocLazyLoad","$translateModuleLoader"];var t=arguments;return{deps:e}}u.$inject=["$sce"];var l={basepath:a,themepath:c,resolveFor:i,dummyTemplate:"<ui-view />",package:o,$get:u};return l}r.$inject=["APP_REQUIRES","ApiProvider","$stateProvider","_"],angular.module("scp.router").provider("RouteHelpers",r)}(),function(){"use strict";function r(r,e){r.config({debug:!1,events:!0,modules:e.modules})}r.$inject=["$ocLazyLoadProvider","APP_REQUIRES"],angular.module("scp.router.lazyload").config(r)}(),function(){"use strict";angular.module("scp.router.lazyload").constant("APP_REQUIRES",{scripts:{},modules:[]})}();