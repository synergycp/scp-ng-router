...
!function(){"use strict";angular.module("scp.router",["ui.router","oc.lazyLoad","ct.ui.router.extras","scp.router.lazyload"])}(),function(){"use strict";angular.module("scp.router.lazyload",[])}(),function(){"use strict";function r(r,t,n,e){function u(r,t,n){function u(){return e.map(arguments,e.ary(t.addPart,1)),n.refresh()}function a(t){return r.trustAsResourceUrl(t)}function s(){function r(r){return a(t.asset(r))}var t=c.apply(null,arguments);return t.trustedAsset=r,t}var i=e.clone(f);return i.trusted=a,i.package=s,i.export=o,i.loadLang=u,i}function o(r){return new a(r)}function a(r){function t(r){return u=n(r),e}function n(r){return u+"/"+r}var e=this,u="vendor/"+r;e.root=t,e.path=n}function c(r){return new l(r)}function s(r){return"app/"+r}function i(r){return"vendor/scp-angle/dist/"+r}function l(r){function e(t){return"lang:pkg:"+r+":"+t}function u(r,t){return n.state(r,t),c}function o(r){return t.baseUrl()+s+r}function a(r){return"raw:"+o(r)}var c=this,s="pkg/"+r+"/";c.asset=o,c.lang=e,c.state=u,c.raw=a}function d(){function t(t,u,o,a,c){function s(r){var n=t.when(r);return"function"==typeof r?n.then(r):d=n.then(i.bind(null,r,d)).catch(function(t){console.error("Error loading: ",r,t)})}function i(r,t){function n(){return i(s,d)}var e=r.split(":"),u=e.shift(),s=e.join(":");switch(u){case"lang":return c.loadLang(s);case"inject":return o.get(s)();case"raw":return a.load(s);case"after":var d=t.then(n);return d}var f=l(r);return f?a.load(f):$.error("Route resolve: Bad resource name ["+r+"]")}function l(t){if(r.modules)for(var n in r.modules)if(r.modules[n].name&&r.modules[n].name===t)return r.modules[n];return r.scripts&&r.scripts[t]}var d;return t.all(e.map(n,s))}t.$inject=["$q","$timeout","$injector","$ocLazyLoad","RouteHelpers"];var n=arguments;return{deps:t}}u.$inject=["$sce","$translateModuleLoader","$translate"];var f={basepath:s,themepath:i,resolveFor:d,dummyTemplate:"<ui-view />",package:c,$get:u};return f}r.$inject=["APP_REQUIRES","ApiProvider","$stateProvider","_"],angular.module("scp.router").provider("RouteHelpers",r)}(),function(){"use strict";function r(r,t){r.config({debug:!1,events:!0,modules:t.modules})}r.$inject=["$ocLazyLoadProvider","APP_REQUIRES"],angular.module("scp.router.lazyload").config(r)}(),function(){"use strict";angular.module("scp.router.lazyload").constant("APP_REQUIRES",{scripts:{},modules:[]})}();